...
class role(commands.Cog):
    ...
    async def on_message(self, ctx):
        ...
        nick_registr = ['Пра', 'ФСБ', 'ГУВД', 'РУВД', 'ПЭ', 'МЗ', 'ПЛ', 'Армия', 'ТСР', 'ЦБ', 'НГ', 'РОВД', 'КМ', 'ФМ', 'СТ', 'СБ', 'РМ', 'УМ', 'ЧК']
        gos = ['Пра', 'ФСБ', 'ГУВД', 'РУВД', 'ПЭ', 'МЗ', 'ПЛ', 'Армия', 'ТСР', 'ЦБ', 'НГ', 'РОВД']

...
global RCH
RCH = ['Пра', 'ФСБ', 'ГУВД', 'РУВД', 'ПЭ', 'МЗ', 'ПЛ', 'Армия', 'ТСР', 'ЦБ', 'НГ', 'РОВД', 'КМ', 'ФМ', 'СТ', 'СБ', 'РМ', 'УМ', 'ЧК']
...
class role(commands.Cog):
    ...
    async def on_message(self, ctx):
        ...
        nick_registr = ['Пра-во', 'РОВД', 'Банк', 'ФСБ', 'РУВД', 'ГУВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'Судья', 'КМ', 'ФМ', 'СТ', 'СБ', 'РМ', 'УМ', 'ЧК'] # Сюда вообще все теги добавь, если там что-то новое будет, если заменят, удаляй то, чего больше нету и вставляй новое, так же.
        gos = ['Пра-во', 'РОВД', 'Банк', 'ФСБ', 'РУВД', 'ГУВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'Судья'] # Сюда все теги госов, по такому же принципу, если вдруг новые появятся 
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        role_checkers = [478970291444383766, 848630088170078269, 848658294759227392, 848660081222483988, 848661195166842900, 848663860399046666, 848664593524850748, 848971714858844191, 848973072006512676, 848974272541622362, 848977375093325844, 848977843228115024, 479198132211548161, 479049028705976340, 479049200768647169, 479198415578988554, 479198488563810315, 479185785510166567]

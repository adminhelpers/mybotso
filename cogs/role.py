...
class role(commands.Cog):
    ...
    async def on_message(self, ctx):
        ...
        nick_registr = ['Пра-во', 'РОВД', 'Банк', 'ФСБ', 'РУВД', 'ГУВД', 'Армия', 'ТСР', 'МРЭО', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья', 'КМ', 'ФМ', 'СТ', 'СБ', 'РМ', 'УМ', 'ЧК'] # Сюда вообще все теги добавь, если там что-то новое будет, если заменят, удаляй то, чего больше нету и вставляй новое, так же.
        gos = ['Пра-во', 'РОВД', 'Банк', 'ФСБ', 'РУВД', 'ГУВД', 'МРЭО', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья'] # Сюда все теги госов, по такому же принципу, если вдруг новые появятся 

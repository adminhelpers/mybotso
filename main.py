...
global RCH
RCH = ['Пра', 'ФСБ', 'ГИБДД', 'РУВД', 'ПЭ', 'МЗ', 'ПЛ', 'Армия', 'ТСР', 'ЦБ', 'НГ', 'РОВД', 'МРЭО', 'КМ', 'ФМ', 'СТ', 'СБ', 'РМ', 'УМ', 'ЧК']
...
role_checkers = [478970291444383766, # ★ Правительство ★
                ...
                848661195166842900, # ★ Районное Управление Внутренних Дел ★
...
global nick_registr
nick_registr = ['Пра-во', 'ЦБ', 'МРЭО', 'ФСБ', 'ГИБДД', 'РУВД', 'РОВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья', 'ФМ', 'СТ', 'СБ', 'ЧК', 'КМ', 'РМ', 'УМ']

global gos
gos = ['Пра-во', 'ЦБ', 'МРЭО', 'ФСБ', 'ГИБДД', 'РУВД', 'РОВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья'] 
...
ROLES = {
  ...
  'ЦБ': 848658294759227392, # ★ Центральный Банк ★
  ...
  'РУВД': 848661195166842900, # ★ Районное Управление Внутренних Дел ★
...
async def on_message(ctx):
    ...
    if msg in role_registr:
        ...
        if not z in nick_registr:
            ...
            embed.add_field(name = f'**Тэги Государственных Организаций:**', value = f'> `Пра-во, ЦБ, МРЭО, ФСБ, ГИБДД, РУВД, РОВД, Армия, ТСР, НГ-А, НГ-Л, МЗ-А, МЗ-Э, МЗ-Л, Судья`')

...
role_checkers = [478970291444383766, # ★ Правительство ★
                ...
                860207024930160680, # ★ Центр Лицензирования ★
                ...
                862361473988821012, # ★ Новостное Агенство г.Лыткарино ★
                848974272541622362, # ★ Министерство Здравоохранения г.Арзамас ★
                865145094331826177, # ★ Министерство Здравоохранения г.Лыткарино ★
...
global nick_registr
nick_registr = ['Пра-во', 'Банк', 'ЦЛ', 'ФСБ', 'ГИБДД', 'ГУВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Л', 'Судья', 'ФМ', 'СТ', 'СБ', 'ЧК', 'КМ', 'РМ', 'УМ']

global gos
gos = ['Пра-во', 'Банк', 'ЦЛ', 'ФСБ', 'ГИБДД', 'ГУВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Л', 'Судья'] 
...
ROLES = {
  ...
  'ЦЛ': 860207024930160680, # ★ Центр Лицензирования ★
  ...
  'НГ-Л': 862361473988821012, # ★ Новостное Агенство г.Лыткарино ★
  'МЗ-А': 848974272541622362, # ★ Министерство Здравоохранения г.Арзамас ★
  'МЗ-Л': 865145094331826177, # ★ Министерство Здравоохранения г.Лыткарино ★
...
async def shop(ctx): 
    await ctx.message.delete()
    e = discord.Embed(title = '⠀⠀⠀⠀«:money_with_wings: **Магазин Север** :money_with_wings:» ─ это магазин Северного Округа, в котором можно приобрести:', description = '\\🔹**Личная роль**\nВозможность сделать свой профиль на сервере уникальным будет стоить тебе `500❄️`\nЗа месяц может быть продано **5** личных ролей.\n⠀⠀⠀⠀__Форма запроса заказа:__\n⠀⠀*1. Название роли (может включать в себя не более двух смайлов и не содержать оскорблений в любом виде)*\n⠀⠀*2. Цвет в формате `#3a2a2a` (цвет также должен быть оригинальным на сервере)*\nЛюбое последующее внесение изменений обойдется в `50❄️`\n\n\\🔹**Семейная роль**\nСемейная роль дает доступ к семейному текстовому и голосовому чату. Ты можешь пригласить в свою семью любого участника сервера, а также, назначить до 4-х заместителей своей фамы и другое. `Цена: 800❄️`\n⠀⠀⠀⠀__Форма запроса заказа:__\n⠀⠀*1. Название семейной роли (может включать в себя не более двух смайлов и не содержать оскорблений в любом виде)*\n⠀⠀*2. Цвет в формате `#3a2a2a` (цвет также должен быть оригинальным на сервере)*\n\n\\💥 Популярная игровая фама имеет право на предоставление скидки на создание роли в 50% `Цена в таком случае: 400❄️` (Обязательно предоставление доказательств. В случае обмана вы будете навсегда забанены в Discord.)\n⠀⠀__Критерии:__\n\\🔸 *семья, имеет от 100 человек в семье;*\n\\🔸 *уровень семьи выше 30;*\n\\🔸 *приватная семья, которая имеет все улучшения.*\n\n\\🔹 роль <@&805493447674036234>, которая позволяет включать музыку в музыкальных каналах. `Цена: 30❄️`\n\\🔹 роль <@&805487952620814387>, которая позволяет включать музыку во всех каналах, даже фракций. `Цена: 50❄️`\n\n\\🔹 роль <@&919225514663772181>, позволяющая отправлять медиа-файлы в общий чат. `Цена: 100❄️`\n\n\🔹 роль <@&805487941899649075>, дающая доступ к текстовому и голосовому чату всех фракций, а также к чату всех элитных пользователей. `Цена: 300❄️`\n\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\\❄️**__Роли для покраски профиля__** \\❄️\nТы можешь арендовать себе роль из списка ниже, сроком на один месяц. `Цена: 20❄️`\n\n\\🔹 <@&936165314276753418>\n\\🔹 <@&936165406295613490>\n\\🔹 <@&936165418572337152>\n\\🔹 <@&936165424683438090>\n\\🔹 <@&936165592782753852>\n\\🔹 <@&936165651565916200>\n\\🔹 <@&936165721669525554>\n\\🔹 <@&936165798584664065>\n\\🔹 <@&936169110990102529>\n\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\\❄️**__Роли для украшения профиля__** \\❄️\nТы можешь арендовать себе роль из списка ниже, сроком на один месяц. `Цена: 40❄️`\n\n\\🔹 <@&886187186066690068>\n\\🔹 <@&886188540998860831>\n\\🔹 <@&886188961217802250>\n\\🔹 <@&886189459534667836>\n\\🔹 <@&886208489628794920>\n\\🔹 <@&886207966255153182>\n\\🔹 <@&886208289413672990>\n\\🔹 <@&886190373758705694>\n\\🔹 <@&886190189024804894>\n\\🔹 <@&886208927249870898>\n\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\\❄️**__Роли доступа к фракциям__** \\❄️\nТы можешь арендовать себе роль, позволяющую получить доступ к голосовому каналу государственных / нелегальных организаций. Срок действия \"аренды\" ─ одна неделя. `Цена: 20❄️`\n:exclamation: *Роль может быть снята раньше срока, при поступлении жалоб на твое поведение в каналах.*\n\\🔹 <@&909365120235368449>\n\\🔹 <@&909364944091365419>\n\n`Для заказа услуг, либо отправления заказа продавцам, напиши любое слово в данный текстовый канал, после чего в созданном текстовом канале ты сможешь задать свой заказ.`\n`Также ты можешь узнать информацию о том, как и кому перевести игровую валюту в валюту Discord.`\n`Стоимость одной снежинки❄️ ─ 500к игровой валюты.`\n`Для закрытия данного канала используй команду !close_buy(cb|закрыть)`', color=0x0CDEE7)
    e.set_footer(text = f'Support Team by dollar ム baby#3603 & lalalalal#5637', icon_url = 'https://images-ext-1.discordapp.net/external/cVW5pAsyoLnQiTP-DZzQ3hLnIq-2Kw3rBZUVZ33Cz30/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/729309765431328799/684fd7878d39ba93511700dbf7a45931.webp?width=677&height=677')
...
async def on_message(ctx):
    ...
    if msg.replace('-', '').replace('+', '') in role_registr:
        ...
        if not z in nick_registr:
            ...
            embed.add_field(name = f'**Тэги Государственных Организаций:**', value = f'> `Пра-во, Банк, ЦЛ, ФСБ, ГИБДД, ГУВД, Армия, ТСР, НГ-А, НГ-Л, МЗ-А, МЗ-Л, Судья`')

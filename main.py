...
async def getruless(ctx): 
    await ctx.message.delete()
    e = discord.Embed(title = '⠀⠀⠀⠀«:money_with_wings: **Магазин Север** :money_with_wings:» ─ это официальный магазин Северного Округа, в котором можно приобрести:', description = '\\🔹**Личная роль**\nВозможность сделать свой профиль на сервере уникальным будет стоить тебе `500❄`\nЗа месяц может быть продано **5** личных ролей.\n⠀⠀⠀⠀__Форма запроса заказа:__\n⠀⠀*1. Название роли (может включать в себя не более двух смайлов и не содержать оскорблений в любом виде)*\n⠀⠀*2. Цвет в формате `#3a2a2a` (цвет также должен быть оригинальным на сервере)*\nЛюбое последующее внесение изменений обойдется в `50❄`\n\n\\🔹**Семейная роль**\nСемейная роль дает доступ к семейному текстовому и голосовому чату. Ты можешь пригласить в свою семью любого участника сервера, а также, назначить до 4-х заместителей своей фамы и другое. `Цена: 800❄`\n⠀⠀⠀⠀__Форма запроса заказа:__\n⠀⠀*1. Название семейной роли (может включать в себя не более двух смайлов и не содержать оскорблений в любом виде)*\n⠀⠀*2. Цвет в формате `#3a2a2a` (цвет также должен быть оригинальным на сервере)*\n\n\\💥 Популярная игровая фама имеет право на предоставление скидки на создание роли в 50% `Цена в таком случае: 400❄` (Обязательно предоставление доказательств. В случае обмана вы будете навсегда забанены в Discord)\n⠀⠀__Критерии:__\n\\🔸 *семья, имеет от 100 человек в семье;*\n\\🔸 *уровень семьи выше 30;*\n\\🔸 *приватная семья, которая имеет все улучшения.*\n\n\\🔹 роль <@&805493447674036234>, которая позволяет включать музыку в музыкальных каналах. `Цена: 30❄`\n\\🔹 роль <@&805487952620814387>, которая позволяет включать музыку во всех каналах, даже фракций. `Цена: 50❄`\n\n\\🔹 роль <@&805487941899649075>, дающая доступ к текстовому и голосовому чату всех фракций, а также к чату всех элитных пользователей. `Цена: 300❄`\n\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\\❄**__Роли для украшения профиля__** \\❄\nТы можешь арендовать себе роль из списка ниже, сроком на один месяц. `Цена: 40❄`\n\\🔹 <@&886187186066690068>\n\\🔹 <@&886188540998860831>\n\\🔹 <@&886188961217802250>\n\\🔹 <@&886189459534667836>\n\\🔹 <@&886208489628794920>\n\\🔹 <@&886207966255153182>\n\\🔹 <@&886208289413672990>\n\\🔹 <@&886190373758705694>\n\\🔹 <@&886190189024804894>\n\\🔹 <@&886208927249870898>\n\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\\❄**__Роли доступа к фракциям__** \\❄", value="Ты можешь арендовать себе роль, позволяющую получить доступ к голосовому каналу государственных / нелегальных организаций. Срок действия \"аренды\" ─ одна неделя. `Цена: 20❄`\n:exclamation: *Роль может быть снята раньше срока, при поступлении жалоб на твое поведение в каналах.*\n\\🔹 <@&909365120235368449>\n\\🔹 <@&909365120235368449>\n\n`Для заказа услуг, либо отправления заказа продавцам, напиши любое слово в данный текстовый канал, после чего в созданном текстовом канале ты сможешь задать свой заказ.`\n`Также ты можешь узнать информацию о том, как и кому перевести игровую валюту в валюту Discord.`\n`Стоимость одной снежинки❄ ─ 500к игровой валюты.`\n`Для закрытия данного канала используй команду !close_buy(cb|закрыть)`', colour = color=0x0CDEE7)

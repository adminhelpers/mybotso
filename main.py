...
global nick_registr
nick_registr = ['Пра-во', 'ЦБ', 'МРЭО', 'ФСБ', 'ГИБДД', 'ГУВД', 'РОВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья', 'ФМ', 'СТ', 'СБ', 'ЧК', 'КМ', 'РМ', 'УМ']

global gos
gos = ['Пра-во', 'ЦБ', 'МРЭО', 'ФСБ', 'ГИБДД', 'ГУВД', 'РОВД', 'Армия', 'ТСР', 'НГ-А', 'НГ-Л', 'МЗ-А', 'МЗ-Э', 'МЗ-Л', 'Судья'] 
